...
const Skills = () => {
  ...
  return (
    <div className="skills max-w-[1366px] mx-auto px-2 md:px-0">
      ...
      <div
        ref={containerRef}
        className="skills-container border border-white/15 rounded-lg mt-10 flex gap-3 py-5 md:py-10 lg:py-16 flex-wrap justify-center items-center group"
        data-spotlight
      >
        {skillsIcon.map((skill) => (
          ...
          >
            <div className="relative h-full w-full bg-slate-900 py-4 lg:p-6 lg:pb-8 rounded-[inherit] z-20 overflow-hidden flex flex-col items-center justify-center gap-1 md:gap-3">
              ...
              <span className="text-gray-400 text-center text-xs md:text-md relative">
                {skill.iconName}
              </span>
            </div>
          </div>
